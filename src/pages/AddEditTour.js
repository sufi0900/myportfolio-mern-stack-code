            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  value={tourData.imageFile} // Display imageFile value here
                  onChange={(e) =>
                ...
                />
                {tourData.imageFile && ( // Display image preview only if imageFile is present
                  <img
                    src={tourData.imageFile}
                    alt="Preview"
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  value={tourData.imageFile1} // Display imageFile value here
                  onChange={(e) =>
                    setTourData((prevData) => ({
                      ...prevData,
                ...
                />
                {tourData.imageFile1 && ( // Display image preview only if imageFile is present
                  <img
                    src={tourData.imageFile1}
                    alt="Preview"
                    style={{ marginTop: "10px", maxWidth: "100%" }}
                  />
                )}
